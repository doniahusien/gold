...
>
      ...
      >
        ...
        <div
          class="absolute space-y-5 inset-0 md:max-w-7xl  mx-auto text-white flex flex-col justify-center z-10  opacity-0 translate-y-6 slide-content px-4 md:px-0"
        >
          <div
            v-html="item.title"
          ...
          <div v-html="item.desc" class="text-sm md:text-2xl max-w-2xl mb-6 font-medium leading-relaxed"></div>
